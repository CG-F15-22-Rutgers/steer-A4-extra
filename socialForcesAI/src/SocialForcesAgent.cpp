...
void SocialForcesAgent::computePlan2(float dt)
{
	if (astar.computePath(__path2, _position, _goalQueue.back().targetLocation, gSpatialDatabase, dt))
	{
		//std::cout << " check cp2" << std::endl;
		while (!_goalQueue.empty())
			_goalQueue.pop();
